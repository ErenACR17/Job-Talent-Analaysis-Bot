This project is a data engineering project that automatically scans ads from the job search site kariyer.net, cleans the data and stores it in the database and analyzes and visualizes the most sought-after competencies in the sector (Python, SQL, Communication, etc.).
...
Job Posting and Talent Analysis Bot
